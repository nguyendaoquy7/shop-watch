...
///////picture delete/////////
$result=mysqli_query($con,"select product_image from product where product_id='$product_id'")
	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($con,"select product_id,product_image, product_title,product_price from product  where  product_cat=1  Limit $page1,12")or die ("query 1 incorrect.....");
