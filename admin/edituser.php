...
$result=mysqli_query($conn,"select id,first_name,last_name, email, password from user_info where id='$user_id'")or die ("query 1 incorrect.......");
...
mysqli_query($conn,"update user_info set first_name='$first_name', last_name='$last_name', email='$email', password='$user_password' where id='$user_id'")or die("Query 2 is inncorrect..........");
